...
![](images/clipboard-3927974927.png)a. Is the control chart an example of descriptive, predictive, or prescriptive analytics?
...
![](images/clipboard-2606621372.png)Our goal (step 5) is to find the price that maximizes expected revenue. Revenue = demand x price which is (–1.4028(Price) + 102.65)  x (Price) = –1.40228(Price)^2^ + 102.65(Price). The revenue as a function of price is shown below for \$10 increments of price.
...
### ![](images/clipboard-2759100757.png)
